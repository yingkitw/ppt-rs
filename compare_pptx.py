...
def compare_files(file1_path, file2_path):
        ...
        for filename in sorted(differences.keys()):
            ...
            if not xml1:
                ...
                if diff_lines:
                    ...
                    for i, line in enumerate(diff_lines[:20]):  # Show first 20 lines
                        print(f"    {line.rstrip()}")
    ...
    print(f"File 1 (python-pptx): {size1:,} bytes")
    ...
    if only_in_1:
        print(f"\nOnly in File 1 (python-pptx): {len(only_in_1)} files")
...
if __name__ == "__main__":
    ...
    file2 = "examples/output/simple_alignment_ppt_rs.pptx"
    ...
    if not Path(file2).exists():
        ...
        print("Run: cargo run --example simple_alignment")
        sys.exit(1)
